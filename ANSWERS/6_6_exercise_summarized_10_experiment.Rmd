...
metadata <- list(name1 = miame$details[1] %>% as.character(),
                 name2 = miame$details[2] %>% as.character(),
                 lab = miame$details[3] %>% as.character(),
                 email = miame$details[4] %>% as.character(),
                 abstract = miame$details[5] %>% as.character(),
                 url = miame$details[6] %>% as.character(),
                 notes = miame$details[7] %>% as.character())
